...
def theme(name, appearance, roles, S):
    ...
    style = {
        ...
        "pane.focused_border": sel, "pane_group.border": S["border"],
        "tab_bar.background": S["panel"], "tab.active_background": S["editor"], "tab.inactive_background": S["panel"],
        "title_bar.background": S["toolbar"], "title_bar.inactive_background": S["toolbar"],
        "status_bar.background": S["toolbar"], "toolbar.background": S["editor"],
        "border": S["border"], "border.variant": S["border_variant"], "border.focused": sel, "border.selected": sel,
        "border.transparent": "#00000000", "border.disabled": S["border_variant"],
        ...
        "scrollbar.track.background": "#00000000", "scrollbar.track.border": S["border_variant"],
